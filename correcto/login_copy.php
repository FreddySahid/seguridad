<?php
$db = new PDO('mysql:host=pruebas2.cjaya8wvxq54.us-east-2.rds.amazonaws.com; dbname=pruebas2','admin504','eO08Wh2Dan36');
             ...
             <p>Llantas Max</p>
                <form action="login_copy.php" method="post" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username"class="form-control" value="" placeholder="Escribe tu nombre de usuario">
              ...
              <button type="button" class="btn btn-link btn-floating mx-1">
                     ...
                     <a href="http://192.168.100.42/">Registrate con Facebook</a>
                     </button>
              </div>
            </div>
          </div>
